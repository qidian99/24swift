...
class ViewController: UIViewController {
    ...
    func setupVision() {
        guard let visionModel = try? VNCoreMLModel(for: MNIST().model) else { fatalError("cannot load Vison ML model")}
...
//        print("haha")
//        debugPrint(classification.first as? Any)
    ...
    @IBAction func recognizeDigit(_ sender: Any) {
        // scale the image to make the result better
